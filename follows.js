(function ( $ ){
	...
	*/
	...
	var defaultKey		= '6uKRDhQDbHq4Cu9YYuAj9CzDq78D5YgwjiBDRVIjKiJ43I0C', // Unique master Xively API key to be used as a default
		defaultFeeds	= [874565597], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Garage Temperature', // Replaces Xively logo in the header
							...
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									datastreamData.datapoints.forEach(function(datapoint) {
										points.push({x: new Date(datapoint.at).getTime()/1000.0, y: 10*parseFloat(datapoint.value)});
									});
